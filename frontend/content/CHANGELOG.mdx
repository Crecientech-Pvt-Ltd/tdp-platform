...
- **[FEATURE]** Added Data Commons module for uploading gene counts, metadata, and contrasts.
- **[FEATURE]** Introduced PCA plots, multi-gene expression plots, and interactive volcano plots for DE analysis.

## v2.0.6-beta

- **[DOCS]** Updated documentation for Target Prioritization Factors, GDA, and Genetics to clarify data sources and formats.
