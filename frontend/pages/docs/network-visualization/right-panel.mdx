...
You can switch "Stop Animation" toggle <Image width={200} height={80} src="/image/docs/animation.png" alt="Animation Toggle" className="inline aspect-auto"/> to stop dancing of the network.
