...
At the main page of our website, you can also click the tab ["Upload Network"](/upload-network) <Image width={200} height={80}  src="/image/docs/upload-network-button.png" alt="Upload Button" className="inline aspect-auto w-36"/> on the left panel, you will see the corresponding dashboard on the right as below:
