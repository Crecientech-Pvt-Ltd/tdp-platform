...
export function GeneSearch() {
	...
	useEffect(() => {
		...
		eventEmitter.on(Events.HIGHLIGHT_SEED_GENES, handleHighlightSeedGenes);

		return () => {
			eventEmitter.off(Events.HIGHLIGHT_SEED_GENES, handleHighlightSeedGenes);
		};
	}, [geneIDs]);
