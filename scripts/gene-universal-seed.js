...
const argv = yargs(process.argv.slice(2))
  ...
  .example(
    chalk.blue(
      "node $0 -f universal.csv -U bolt://localhost:7687 -u neo4j -p password -d pdnet -D MONDO_0004976 --nh -t ENSEMBL-ID"
    )
  )
  .example(
    chalk.blue(
      "node $0 -f universal.csv -U bolt://localhost:7687 -u neo4j -p password -d pdnet --di --nh -t HGNC-Symbol"
    )
  )
