...
export function RadialAnalysis() {
	...
	const updateRadialAnalysis = (
		value: number | string,
		key: keyof RadialAnalysisSetting,
	) => {
						...
						<div className="flex gap-2 items-center">
							<div className="flex flex-col gap-2 w-full">
								...
								<Slider
									id={option.key}
									min={
										option.key === "edgeWeightCutOff" ? minScore : option.min
									}
									max={
										option.key === "nodeDegreeCutOff" && !isGeneDegree
											? 1
											: option.max
									}
									step={
									...
									onValueChange={(value) =>
										updateRadialAnalysis(
											value[0],
											option.key as keyof RadialAnalysisSetting,
										)
									}
								/>
								{option.key === "nodeDegreeCutOff" && (
									<VirtualizedCombobox
										data={[
											"Gene Degree",
											...radioOptions.database.TE,
											...radioOptions.user.TE,
										]}
										width="550px"
										align="end"
										className="w-full"
