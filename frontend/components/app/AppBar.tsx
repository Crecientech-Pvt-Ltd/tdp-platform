		...
		<div className="flex gap-2 items-center">
			<Tooltip>
				...
				<TooltipContent align="start" className="max-w-96 text-sm">
					<ol>
						<li>
							• To select multiple genes and export details or perform GSEA
							analysis, use the mouse to select the genes
							<br />
							<b>
								<i>Shortcut: </i>
							</b>
							<kbd className="border rounded-md px-1"> Shift(⇧) + Click</kbd> &
							Drag
						</li>
						<br />
						<li>
							• To highlight neighbors of a gene, either check Highlight
							Neighbor Genes on Network Style section and then hover/click the
							gene
							<br />
							<b>
								<i>Shortcut: </i>
						...
						<br />
						<li>
							• To highlight a gene via appending it to search textbox, click
							the gene while holding the Cmd/Ctrl(⌘) key
							<br />
							<b>
								<i>Shortcut: </i>
							</b>
