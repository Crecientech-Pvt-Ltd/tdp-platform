...
export function BinaryLegend({
	...
	React.useEffect(() => {
		...
		svg.innerHTML = "";
		const circlePresent = document.createElementNS(
		...
		const circleNotPresent = document.createElementNS(
			"http://www.w3.org/2000/svg",
			"circle",
		);
		...
		const textPresent = document.createElementNS(
			"http://www.w3.org/2000/svg",
			"text",
		);
		...
		const textNotPresent = document.createElementNS(
			"http://www.w3.org/2000/svg",
			"text",
		);
