...
- **Network Visualization Board**: A canvas to render the network visualization. You can find detailed explanation on the page of [Network Visualization - Right panel](docs/network-visualization/network-visualization-board.mdx).
