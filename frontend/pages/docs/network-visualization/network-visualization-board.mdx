...
Now we focus on the functions of network visualization board. You can **hover** on this icon <Image width={200} height={80} src="/image/docs/help-icon.png" alt="Help Icon" className="inline aspect-auto"/> on the top for a quick help of shortcuts.
