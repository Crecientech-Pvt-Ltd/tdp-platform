...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      ...
      max={max}
      className={cn(
        'relative flex w-full touch-none select-none flex-col items-center data-[orientation=vertical]:h-full data-[orientation=vertical]:min-h-44 data-[orientation=vertical]:w-auto data-disabled:opacity-50',
        className,
      )}
      {...props}
    >
